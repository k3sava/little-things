...
Each toy is published as its own GitHub repo (`k3sava/toy-<slug>`) — a single `index.html` plus vendored `_chrome/`, MIT-licensed, forkable. This aggregator repo serves all toys at [toys.iamkesava.com](https://toys.iamkesava.com).

**To use a single toy:**
```bash
git clone https://github.com/k3sava/toy-aurora
open index.html
```
