...
import SchemaGeneratorContent from "./content";
import { TOOL_FAQ } from "@/data/tool-faq";

export const generateMetadata = () => generateToolMetadata("/schema-generator");

const TOOL_HREF = "/schema-generator";
  ...
  return (
    <>
      ...
      <ToolPageWrapper href={TOOL_HREF}>
        <SchemaGeneratorContent faqPassages={faq} />
      </ToolPageWrapper>
    </>
  );
}
