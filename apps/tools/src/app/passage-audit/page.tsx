...
import PassageAuditContent from "./content";
import { TOOL_FAQ } from "@/data/tool-faq";

export const generateMetadata = () => generateToolMetadata("/passage-audit");

const TOOL_HREF = "/passage-audit";
const tool = getToolByHref(TOOL_HREF)!;
const collection = getPrimaryCollection(tool);

export default function PassageAuditPage() {
  ...
  return (
    <>
      ...
      <ToolPageWrapper href={TOOL_HREF}>
        <PassageAuditContent faqPassages={faq} />
      </ToolPageWrapper>
    </>
  );
}
