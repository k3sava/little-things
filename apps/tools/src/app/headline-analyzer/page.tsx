...
import HeadlineAnalyzerContent from "./content";
import { TOOL_FAQ } from "@/data/tool-faq";

export const generateMetadata = () => generateToolMetadata("/headline-analyzer");

const TOOL_HREF = "/headline-analyzer";
  ...
  return (
    <>
      ...
      <ToolPageWrapper href={TOOL_HREF}>
        <HeadlineAnalyzerContent faqPassages={faq} />
      </ToolPageWrapper>
    </>
  );
}
