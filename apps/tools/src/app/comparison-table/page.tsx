...
import ComparisonTableContent from "./content";
import { TOOL_FAQ } from "@/data/tool-faq";

export const generateMetadata = () => generateToolMetadata("/comparison-table");

const TOOL_HREF = "/comparison-table";
  ...
  return (
    <>
      ...
      <ToolPageWrapper href={TOOL_HREF}>
        <ComparisonTableContent faqPassages={faq} />
      </ToolPageWrapper>
    </>
  );
}
