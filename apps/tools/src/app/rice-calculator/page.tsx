...
import RiceCalculatorContent from "./content";
import { TOOL_FAQ } from "@/data/tool-faq";

export const generateMetadata = () => generateToolMetadata("/rice-calculator");

const TOOL_HREF = "/rice-calculator";
  ...
  return (
    <>
      ...
      <ToolPageWrapper href={TOOL_HREF}>
        <RiceCalculatorContent faqPassages={faq} />
      </ToolPageWrapper>
    </>
  );
}
