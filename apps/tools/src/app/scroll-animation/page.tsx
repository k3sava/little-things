...
import ScrollAnimationContent from "./content";
import { TOOL_FAQ } from "@/data/tool-faq";

export const generateMetadata = () => generateToolMetadata("/scroll-animation");

const TOOL_HREF = "/scroll-animation";
  ...
  return (
    <>
      ...
      <ToolPageWrapper href={TOOL_HREF}>
        <ScrollAnimationContent faqPassages={faq} />
      </ToolPageWrapper>
    </>
  );
}
