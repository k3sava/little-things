...
import GlassmorphismContent from "./content";
import { TOOL_FAQ } from "@/data/tool-faq";

export const generateMetadata = () => generateToolMetadata("/glassmorphism");

const TOOL_HREF = "/glassmorphism";
  ...
  return (
    <>
      ...
      <ToolPageWrapper href={TOOL_HREF}>
        <GlassmorphismContent faqPassages={faq} />
      </ToolPageWrapper>
    </>
  );
}
