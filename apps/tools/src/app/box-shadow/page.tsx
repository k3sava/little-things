...
import BoxShadowContent from "./content";
import { TOOL_FAQ } from "@/data/tool-faq";

export const generateMetadata = () => generateToolMetadata("/box-shadow");

const TOOL_HREF = "/box-shadow";
  ...
  return (
    <>
      ...
      <ToolPageWrapper href={TOOL_HREF}>
        <BoxShadowContent faqPassages={faq} />
      </ToolPageWrapper>
    </>
  );
}
