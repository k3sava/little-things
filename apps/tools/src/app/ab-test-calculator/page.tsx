...
import ABTestCalculatorContent from "./content";
import { TOOL_FAQ } from "@/data/tool-faq";

export const generateMetadata = () => generateToolMetadata("/ab-test-calculator");

const TOOL_HREF = "/ab-test-calculator";
  ...
  return (
    <>
      ...
      <ToolPageWrapper href={TOOL_HREF}>
        <ABTestCalculatorContent faqPassages={faq} />
      </ToolPageWrapper>
    </>
  );
}
