...
import FindReplaceContent from "./content";
import { TOOL_FAQ } from "@/data/tool-faq";

export const generateMetadata = () => generateToolMetadata("/find-replace");

const TOOL_HREF = "/find-replace";
  ...
  return (
    <>
      ...
      <ToolPageWrapper href={TOOL_HREF}>
        <FindReplaceContent faqPassages={faq} />
      </ToolPageWrapper>
    </>
  );
}
