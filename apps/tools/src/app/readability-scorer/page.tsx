...
import ReadabilityScorerContent from "./content";
import { TOOL_FAQ } from "@/data/tool-faq";

export const generateMetadata = () => generateToolMetadata("/readability-scorer");

const TOOL_HREF = "/readability-scorer";
  ...
  return (
    <>
      ...
      <ToolPageWrapper href={TOOL_HREF}>
        <ReadabilityScorerContent faqPassages={faq} />
      </ToolPageWrapper>
    </>
  );
}
