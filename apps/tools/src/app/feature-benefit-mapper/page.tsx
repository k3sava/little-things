...
import FeatureBenefitMapperContent from "./content";
import { TOOL_FAQ } from "@/data/tool-faq";

export const generateMetadata = () => generateToolMetadata("/feature-benefit-mapper");

const TOOL_HREF = "/feature-benefit-mapper";
const tool = getToolByHref(TOOL_HREF)!;
const collection = getPrimaryCollection(tool);

export default function FeatureBenefitMapperPage() {
  ...
  return (
    <>
      ...
      <ToolPageWrapper href={TOOL_HREF}>
        <FeatureBenefitMapperContent faqPassages={faq} />
      </ToolPageWrapper>
    </>
  );
}
