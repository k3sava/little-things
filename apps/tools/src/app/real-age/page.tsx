...
import RealAgeContent from "./content";
import { TOOL_FAQ } from "@/data/tool-faq";

export const generateMetadata = () => generateToolMetadata("/real-age");

const TOOL_HREF = "/real-age";
const tool = getToolByHref(TOOL_HREF)!;
const collection = getPrimaryCollection(tool);

export default function RealAgePage() {
  ...
  return (
    <>
      ...
      <ToolPageWrapper href={TOOL_HREF}>
        <RealAgeContent faqPassages={faq} />
      </ToolPageWrapper>
    </>
  );
}
