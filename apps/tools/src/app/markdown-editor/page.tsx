...
import MarkdownEditorContent from "./content";
import { TOOL_FAQ } from "@/data/tool-faq";

export const generateMetadata = () => generateToolMetadata("/markdown-editor");

const TOOL_HREF = "/markdown-editor";
  ...
  return (
    <>
      ...
      <ToolPageWrapper href={TOOL_HREF}>
        <MarkdownEditorContent faqPassages={faq} />
      </ToolPageWrapper>
    </>
  );
}
