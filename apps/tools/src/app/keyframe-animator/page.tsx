...
import KeyframeAnimatorContent from "./content";
import { TOOL_FAQ } from "@/data/tool-faq";

export const generateMetadata = () => generateToolMetadata("/keyframe-animator");

const TOOL_HREF = "/keyframe-animator";
const tool = getToolByHref(TOOL_HREF)!;
const collection = getPrimaryCollection(tool);

export default function KeyframeAnimatorPage() {
  ...
  return (
    <>
      ...
      <ToolPageWrapper href={TOOL_HREF}>
        <KeyframeAnimatorContent faqPassages={faq} />
      </ToolPageWrapper>
    </>
  );
}
