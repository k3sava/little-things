...
import PdfCompressContent from "./content";
import { TOOL_FAQ } from "@/data/tool-faq";

export const generateMetadata = () => generateToolMetadata("/pdf-compress");

const TOOL_HREF = "/pdf-compress";
  ...
  return (
    <>
      ...
      <ToolPageWrapper href={TOOL_HREF}>
        <PdfCompressContent faqPassages={faq} />
      </ToolPageWrapper>
    </>
  );
}
