...
import CronBuilderContent from "./content";
import { TOOL_FAQ } from "@/data/tool-faq";

export const generateMetadata = () => generateToolMetadata("/cron-builder");

const TOOL_HREF = "/cron-builder";
  ...
  return (
    <>
      ...
      <ToolPageWrapper href={TOOL_HREF}>
        <CronBuilderContent faqPassages={faq} />
      </ToolPageWrapper>
    </>
  );
}
